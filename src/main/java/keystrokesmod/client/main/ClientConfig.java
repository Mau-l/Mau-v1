...
public class ClientConfig {
    ...
    private final File cfgDir = new File(Minecraft.getMinecraft().mcDataDir + File.separator + "mau");
    ...
    public void applyKeyStrokeSettingsFromConfigFile() {
        try {
            final JsonObject data = config.get("mau").getAsJsonObject();
    ...
    public void updateKeyStrokesSettings() {
        config.add("mau", getKeystrokeAsJson());
        saveConfig();
    }
}
